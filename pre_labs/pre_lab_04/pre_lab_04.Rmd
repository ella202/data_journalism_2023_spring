...
**Task** Run the following code to group and count records in the Grantee column, and filter to examine only recipients that start with W. Name a problem that you see that is preventing proper grouping. **Answer** The grantees Washington County Community Action Council (Cac) and Washington County Community Action Council (FY15) are probably the same thing, but they're spelled differently. 
...
**Answer** Grantees vs grantees clean are not the same in terms of capitalization and there aren't duplicates. 
...
**Task** Run the following code to group by grantee_clean and Grantee, then filter for recipients that start with W. Name three changes the refinr function made in the first 30 results. **Answer** Likely grantee duplicates are not present, there's no mutate or case_when necessary and you see both grantee and grantee_clean
...
**Answer** The change isn't that drastic but of course it's just a guess.
