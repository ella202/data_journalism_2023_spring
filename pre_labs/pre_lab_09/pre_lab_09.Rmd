...
md_gov_map <- md_gov_county %>%
  mutate(total_votes = Cox + Moore + Lashar + Wallace + Harding + `Write-ins`) %>%
  mutate(pct_moore = Moore/total_votes*100)

write_csv(md_gov_map, "data/md_gov_county.csv")
```
...
The visual only includes colored counties in Maryland
...
https://datawrapper.dwcdn.net/rVFp4/1/
