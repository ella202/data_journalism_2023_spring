...
**Answer** creates the percentage of votes for moore
...
**Answer** sorts row from highest to lowest vote percentage  
...
**Answer** It might be useful for reelection, so the next Democratic candidate know which county to target
...
**Answer** str_to_lower() converts to lower case and str_to_sentence() convert to sentence case, where only the first letter of sentence is capitalized.
...
**Answer** The mutation only made the states mentioned appear. The other states are "NA" instead. 
...
**Answer** not really because it doesn't provide who/what the money is going toward.
...
1. Which individual paid the greatest expense?

2. How much was paid in cash and checks?

3. how many organizations paid more than $20000?
