...
**Answer** Adding a column with the month labeled, and summarizing the total calls for each month.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** A bar chart with a labeled x and y axis 
...
**Answer** The reorder function is used to sort from lowest to highest
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** Changes the style of the chart, clean it up
...
**Answer** You can create different themes for the charts
```{r}
baltco_911_calls_by_month %>%
  ggplot() +
  geom_bar(aes(x=reorder(month,total_calls), weight=total_calls)) +
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** You don't need to abbreviate labels in the chart
...
### Task 12: Create a dataframe of contributions by date

**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** Dates instead of months
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** The chart is a line chart 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** all the dates are too close together
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** Dates have been rotated to be seen better
```{r}
baltco_911_calls_by_date %>%
  ggplot() + 
  geom_line(aes(x=date, y=total_calls)) + 
