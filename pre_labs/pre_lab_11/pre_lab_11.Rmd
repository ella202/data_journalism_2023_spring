...
**Answer** They were all released in 2023 and they're character columns
...
**Answer**  Whether the release was deleted.
...
**Task** Run the following code in the gray-colored codeblock below to find the <li> tags. What does the output suggest about how many <li> tags there are in the HTML source?
**Answer** The code takes out all of the 20 or more li tags.
...
**Answer** Whatever is inside the tag is taken out.
...
**Answer** A dataframe of the text is created.
