...
voters_by_county <- voters_by_county %>% slice(-25)
```
...
**Answer** there are a lot of periods by the counties and the headers are labeled with numbers
...
**Answer** Periods still remain and headers aren't names
...
**Answer**
We need to get rid of the ellipses and add more years 
```{r}
