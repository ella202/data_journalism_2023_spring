...
**Answer** There are four columns and the newest column has all the text from every press release
...
**Answer**  terms are devided by capitalized and lowercase words
...
**Answer** the dataframe/column is being cleaned in order to have an easier search
...
**Answer** Not really. There are mostly tansition/filler words in this chart.
...
**Answer** All the stop words are excluded. There are also percentages for this new set of words.
...
**Answer** Covid related words are used less and less each year. All the words change each year.  
...
**Task** Run the following code and describe the results.
**Answer** Text appears as more than a single word, now there are two words per row.There are also no stop words included.
...
**Task** Run the following code and describe the results.
**Answer** There are popular two word combos of 2022. It mentions projects and health care.
...
**Task** Run the following code and describe the results.
**Answer** The words of 2023 look more random and out of place. There are fewer results because we're less than halfway through the year.
...
**Answer** Vulnerable is negative, critical is negative, urgent is negative, consistently is negative.
