...
**Answer**Shapes of the area that the residence is in
...
**Answer** the map is drawm based on zip code boundaries
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Another layer is added that contains census info
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Adds layer of counties to map
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**This is a dataframe that contains Maryland counties 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The Chesapeake Bay isn't present
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** County and zip code layers are essentially being joined
...
**Task** Run the following code. Describe the output in the space below.
**Answer** Has the zip code and March 2023 foreclosure notices
...
**Task** Run the following code. Describe the output in the space below.
**Answer** Zip codes + foreclosures + number of forclsures are joined together
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Light colors on the map have higher number of forclosure notices
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** County columns are turned into rows and notices are listed by county.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** We're getting census data with counties and population count
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The number of notices in the month of March appear.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The dataframe is a lot cleaner and the names of columns make more sense.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Census info and forclosure data are all together.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The population rate is calculated so it can be measured more easily by county. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** There's a map! And it's color coded by the rate of forclosures in each county.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The map's colors are more striking. It might be easier to pick out certain counties.
...
**Answer** The colors of the map look better put together. 
