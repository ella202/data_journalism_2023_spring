...
**Answer** Registration increased over time for democrats and republicans. Democrats more drastically than republicans. 
...
**Answer** There are two columns. Several for the parties.

```{r}
# with nrow included to show row total
maryland_population %>% left_jonew_spotify_youtubein(county_voters_2022, by="COUNTY") %>% nrow()
```
...
**Answer** Various racial/ethnic populations who registered.
...
**Answer** PG county: 60% Black and over 18, 77% of the population are democrats
...
**Answer** The Asian population is incredibly diverse in itself, so the data is very generalized. 
