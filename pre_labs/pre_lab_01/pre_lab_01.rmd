...
**Answer** character (letters/words) and double (numbers)
...
In the space below, write the name of the title from the first row of the "title" column. 
...
``` 
%>% pipe character (shift, command, M)
Describe what you think each line of this code is doing below, based on the result:

**Answer** how many classes were offered at one point in time
...
**Answer** you're arranging the classes in descending order from the most classes
...
**Answer** grouping by term and department, how many classes in a department in a given term
...
Compared to the previous codeblock, what has changed and how did that affect the result? 
**Answer** We see the total number of seats in each term
...
**Answer** Seats have been grouped into various measurements such as mean, median and total for each term
...
**Answer** Data has been categorized by department and also gives the minimum and max number of seats a department has in its classes
