...
**A1** 
Engineering, Cooperative Education had the highest mean of 314 seats
```{r}
umd_courses %>%
  group_by(department) %>%
  summarise(
...
**A2** Doctoral Dissertation Research has been offered 1229 times
...
**A3** Keith Yearwood in Geographical Sciences has taught 58 classes
...
**A4** Putting "group_by" with all the category names made it much easier to find all info I needed to answer the question. 
...
**A5** Which professor has taught the most students? Seats in a class don't necessarily mean the seats in the class were filled, but I would like to know the potential number. James Green has 27335 total seats.
