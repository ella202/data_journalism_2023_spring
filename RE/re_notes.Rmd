...
* **Analysis summary**: [For this question we are comparing MLB donations to several other sports leagues at the same time. We also needed to make sure this didn't involve bipartisan political organizations. We were able to confirm our findings]
...
* **Analysis summary**: [For this code we had to filter for Loeffler's total contributions to the Republican party. We were able to confirm our findings.]
...
* **Analysis summary**: [We had to find the 40 owners who paid the most and then add up all their contributions. We were able to confirm the finding.]
...
* **Analysis summary**: [For this extra bit of code we have to sum up all the contributions, filter out how much the contributions went to between Republicans and Democrats.Findings are a little bit different from what was expected: I got 77.2 percent of the $40 million going to Republican causes and 19.7 percent going to Democrats.]
